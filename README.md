...
* [go-sql-driver](https://github.com/go-sql-driver/mysql) ⭐ 15,276 | 🐛 67 | 🌐 Go | 📅 2026-09-02 - 一个 Go 语言的轻量级、极速的 MySQL 驱动程序。
...
* [MariaDB](https://github.com/MariaDB/server) ⭐ 8,170 | 🐛 474 | 🌐 C++ | 📅 2026-09-02 - MySQL server 的一个由社区开发的分支。
...
* [vitess](https://github.com/youtube/vitess) ⭐ 21,287 | 🐛 1,095 | 🌐 Go | 📅 2026-09-02 - 对于大规模的 web 服务，vitess 提供服务和工具以便于 MySQL 数据库的缩放。
...
* [go-mysql](https://github.com/siddontang/go-mysql) ⭐ 4,964 | 🐛 156 | 🌐 Go | 📅 2026-09-01 - 一个纯 go 的库，用于处理 MySQL 的网络协议和复制。
