...
* [go-sql-driver](https://github.com/go-sql-driver/mysql) ⭐ 15,271 | 🐛 71 | 🌐 Go | 📅 2026-08-27 - 一个 Go 语言的轻量级、极速的 MySQL 驱动程序。
...
* [MySQL Server & MySQL Cluster](https://github.com/mysql/mysql-server) ⭐ 12,409 | 🐛 43 | 🌐 C++ | 📅 2026-08-27 - Oracle 官方的 MySQL server 和 MySQL 集群分布。
* [MariaDB](https://github.com/MariaDB/server) ⭐ 8,161 | 🐛 475 | 🌐 C++ | 📅 2026-08-31 - MySQL server 的一个由社区开发的分支。
...
* [vitess](https://github.com/youtube/vitess) ⭐ 21,282 | 🐛 1,095 | 🌐 Go | 📅 2026-08-31 - 对于大规模的 web 服务，vitess 提供服务和工具以便于 MySQL 数据库的缩放。
...
* [go-mysql](https://github.com/siddontang/go-mysql) ⭐ 4,963 | 🐛 157 | 🌐 Go | 📅 2026-08-23 - 一个纯 go 的库，用于处理 MySQL 的网络协议和复制。
