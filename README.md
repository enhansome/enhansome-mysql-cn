...
* [Sysbench](https://github.com/akopytov/sysbench) ⭐ 6,794 | 🐛 217 | 🌐 C | 📅 2025-03-09 - 一个模块化，跨平台以及多线程的性能测试工具。
...
* [MySQL Server & MySQL Cluster](https://github.com/mysql/mysql-server) ⭐ 12,430 | 🐛 58 | 🌐 C++ | 📅 2026-09-11 - Oracle 官方的 MySQL server 和 MySQL 集群分布。
* [MariaDB](https://github.com/MariaDB/server) ⭐ 8,232 | 🐛 488 | 🌐 C++ | 📅 2026-09-16 - MySQL server 的一个由社区开发的分支。
...
* [vitess](https://github.com/youtube/vitess) ⭐ 21,340 | 🐛 1,114 | 🌐 Go | 📅 2026-09-16 - 对于大规模的 web 服务，vitess 提供服务和工具以便于 MySQL 数据库的缩放。
...
* [go-mysql](https://github.com/siddontang/go-mysql) ⭐ 4,966 | 🐛 156 | 🌐 Go | 📅 2026-09-08 - 一个纯 go 的库，用于处理 MySQL 的网络协议和复制。
