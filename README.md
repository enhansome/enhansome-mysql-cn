...
* [Sysbench](https://github.com/akopytov/sysbench) ⭐ 6,772 | 🐛 217 | 🌐 C | 📅 2025-03-09 - 一个模块化，跨平台以及多线程的性能测试工具。
...
* [MariaDB](https://github.com/MariaDB/server) ⭐ 8,102 | 🐛 454 | 🌐 C++ | 📅 2026-08-15 - MySQL server 的一个由社区开发的分支。
...
* [vitess](https://github.com/youtube/vitess) ⭐ 21,222 | 🐛 1,071 | 🌐 Go | 📅 2026-08-15 - 对于大规模的 web 服务，vitess 提供服务和工具以便于 MySQL 数据库的缩放。
...
* [SQL-exercise](https://github.com/XD-DENG/SQL-exercise) ⭐ 1,526 | 🐛 8 | 📅 2023-11-11 - 包含几个 SQL 练习，包括模式描述，用 SQL 语句去建立模式，SQL 的问题及解决方案。以 wikibook SQL 练习为基础。
